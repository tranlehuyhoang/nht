                            ...
                            ?>
                                        <tr>
                                            <td class="product-remove">
                                                <a href="page/cart.php?delid=<?php echo $result['cartproductid'] ?>" class="remove-wishlist"><svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="20" onclick="return confirm('Delete?')">
                                                        <path d="M18,6h0a1,1,0,0,0-1.414,0L12,10.586,7.414,6A1,1,0,0,0,6,6H6A1,1,0,0,0,6,7.414L10.586,12,6,16.586A1,1,0,0,0,6,18H6a1,1,0,0,0,1.414,0L12,13.414,16.586,18A1,1,0,0,0,18,18h0a1,1,0,0,0,0-1.414L13.414,12,18,7.414A1,1,0,0,0,18,6Z" />
                                                    </svg></a>
                                            </td>
                                            <td class="product-thumbnail"><a href="single-product-3.php"><img src="<?php echo 'data:image/png;base64,' . base64_encode($result['image']); ?>" alt="Digital Product"></a></td>
                                            ...
                                            <td class="product-quantity" data-title="Qty">
                                                <div class="pro-qty">
                                                    <input type="number" class="quantity-input" value="<?php echo $result['cartquantity'] ?>">
                                                </div>
                                            </td>
