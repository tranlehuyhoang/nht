                        ...
                        <div class="col-md-6">
                            <div class="content-blog blog-grid">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        <h5 class="title"><a href="blog-details.php">Keeping yourself safe when
                                                buying NFTs on eTrade</a></h5>

                                        <div class="read-more-btn">
                                            <a class="axil-btn right-icon" href="blog-details.php">Read More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="content-blog blog-grid">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        <h5 class="title"><a href="blog-details.php">Important updates for listing
                        ...
                        <div class="col-md-6">
                            <div class="content-blog blog-grid">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        <h5 class="title"><a href="blog-details.php">10 tips for avoiding scams and
                    ...
                    <aside class="axil-sidebar-area">
                        ...
                        <div class="axil-single-widget mt--40">
                            ...
                            <div class="content-blog post-list-view mb--20">
                                <div class="thumbnail">
                                    <a href="blog-details.php">
                                        <img src="./public/assets_client/images/blog/blog-04.png" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <h6 class="title"><a href="blog-details.php">Dubai’s FRAME Offers its Take on
                                            the</a></h6>
                            ...
                            <div class="content-blog post-list-view mb--20">
                                <div class="thumbnail">
                                    <a href="blog-details.php">
                                        <img src="./public/assets_client/images/blog/blog-05.png" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <h6 class="title"><a href="blog-details.php">Apple presents App Best of 2020
                                            winners</a></h6>
                                    <div class="axil-post-meta">
                                        <div class="post-meta-content">
                                            <ul class="post-meta-list">
                            ...
                            <div class="content-blog post-list-view">
                                <div class="thumbnail">
                                    <a href="blog-details.php">
                                        <img src="./public/assets_client/images/blog/blog-06.png" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <h6 class="title"><a href="blog-details.php">Gallaudet University innovation in
                                            education</a></h6>
                                    <div class="axil-post-meta">
                                        <div class="post-meta-content">
                                            <ul class="post-meta-list">
                        ...
                        <div class="axil-single-widget mt--40">
                            ...
                            <ul class="product_list_widget recent-viewed-product">
                                ...
                                <li>
                                    <div class="thumbnail">
                                        <a href="blog-details.php">
                                            <img src="./public/assets_client/images/product/product-12.jpg"
                                                alt="Blog Images">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="blog-details.php">Men's Fashion Tshirt</a></h6>
                                ...
                                <li>
                                    <div class="thumbnail">
                                        <a href="blog-details.php">
                                            <img src="./public/assets_client/images/product/product-10.jpg"
                                                alt="Blog Images">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="blog-details.php">Nike Shoes</a></h6>
                                        <div class="product-meta-content">
                                            <span class="woocommerce-Price-amount amount">
                                                <del>$200</del>
                                                $150
                                ...
                                <li>
                                    <div class="thumbnail">
                                        <a href="blog-details.php">
                                            <img src="./public/assets_client/images/product/product-11.jpg"
                                                alt="Blog Images">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="blog-details.php">Addidas Shoes</a></h6>
                                        <div class="product-meta-content">
                                            <span class="woocommerce-Price-amount amount">
                                                <del>$300</del>
                                                $200
                        ...
                        <div class="axil-single-widget mt--40 widget_search">
                            ...
                            <form class="blog-search" action="#">
                                <button class="search-button"><svg xmlns="http://www.w3.org/2000/svg" id="Outline"
