                ...
                <div class="position-relative">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <span class="h4 ms-3 text-dark" style="color: white;">Admin <?php echo Session::get('adminName') ?></span>
                        </div>
                ...
                <div class="d-flex justify-content-center p-3 rounded-bottom">
                    <ul class="d-flex align-items-center m-0 p-0">
                        <li class="d-flex align-items-center active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-columns me-1 icon-md text-primary">
                                <path
                                    d="M12 3h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7m0-18H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7m0-18v18">
                                </path>
                            </svg>
                            <a class="pt-1px d-none d-md-block text-primary" href="#">Home</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 grid-margin">
                    <div class="card rounded">
                        ...
                        <div class="card-body">
                            <p class="mb-3 tx-14">
                                - Done add, list, edit, delete > Categories.
                            </p>
                        </div>
